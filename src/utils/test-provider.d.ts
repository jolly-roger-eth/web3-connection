import type { EIP1193Account, EIP1193Provider, EIP1193ProviderWithoutEvents, EIP1193Request } from 'eip-1193';
export declare function initUser(): {
    installBuiltinProvider(): EIP1193Provider<EIP1193Request>;
